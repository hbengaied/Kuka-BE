...
if __name__ == "__main__":
    XM.XmlManager.DeleteFile() # cette méthode statique permet de supprimer le fichier output.xml au début du lancement
    ...
    while(server.kuka_connected == False): # j'attent que le robot soit connecter
        pass
    # lorsque le kuka se connecte je sort de cette boucle et j'instancie la réception de paquet du kuka
